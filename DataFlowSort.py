...
def get_randomized_set_rows(read_obj):
    ...
    validation_set_size = data_size * 0.15 +1
    training_set_size = data_size - 2* validation_set_size

    print(data_size)
    indices = np.arange(int(data_size))
    print(indices[5])
...
with open(FILE_NAME, 'r') as read_obj:
    ...
    train_rows, validation_rows,test_rows = get_randomized_set_rows(read_obj)
