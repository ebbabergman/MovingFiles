...
## ASSUMPTION: labels_path file contains *no dublicates* and *no NA* values
        ...
        def __init__(self,
                        ...
                        #included_classes = ["negcon_PHB000001","negcon_PHB000012","heat shock response signalling agonist", "phosphodiesterase inhibitor", "methyltransferase inhibitor","DILI","HDAC inhibitor","topoisomerase inhibitor", "mTOR inhibitor","NFkB pathway inhibitor","JAK inhibitor","pregnane x receptor agonist"], #Empty for everything included,
                        included_classes = ["negcon_PHB000001","negcon_PHB000012","DNA polymerase inhibitor", "topoisomerase inhibitor"],
